...
Some key functions are **glancer** for visualising experiment results in a plate format. **eggresRThe functions have different flavours, and **emGeezen** is recommended.
