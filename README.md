...
output of plate based biology experiments. The normalisation function is
for **eggresR**ing to remove linear trends. The quick way to install
things is by **chillstall**. The fast way to reload large csv data is by
**fastloadr**.
